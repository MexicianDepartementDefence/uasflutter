// ignore_for_file: prefer_const_constructors, prefer_const_literals_to_create_immutables, use_key_in_widget_constructors, unused_local_variable, sized_box_for_whitespace, sort_child_properties_last
              ...
              child: TextButton(
                onPressed: () {
                  Get.defaultDialog(
                    ...
                    titleStyle: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w700),
                    middleTextStyle: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w500),
                    confirm: ElevatedButton(onPressed: () => Get.offAllNamed(Routes.CRUD_JADWAL), child: Center(child: Text(
                    "Tidak",
                    style: TextStyle(
                        fontSize: 20,
                        fontWeight: FontWeight.w600,
                  ...
                  cancel:  ElevatedButton(onPressed: () => srt.logout(), child: Center(child: Text(
                    "Ya",
                    style: TextStyle(
                        fontSize: 20,
                        fontWeight: FontWeight.w600,
